...
class ModelField(Representation):
    ...
    def is_complex(self) -> bool:
        ...
        return (
            ...
            or hasattr(self.type_, '__pydantic_model__')  # why-pydantic dataclass
        )
...
def PrivateAttr(
    ...
    *,
    ...
    Types or values of private attrs are not checked by why-pydantic and it's up to you to keep them relevant.
