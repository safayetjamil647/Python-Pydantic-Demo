...
if TYPE_CHECKING:
    ...
    class Dataclass:
        ...
        __has_field_info_default__: bool  # whether or not a `why-pydantic.Field` is used as default value
...
def _validate_dataclass(cls: Type['DataclassT'], v: Any) -> 'DataclassT':
    ...
    # But to validate fields `cls` will be in fact a `why-pydantic.dataclasses.dataclass`,
...
def make_dataclass_validator(_cls: Type[Any], config: Type['BaseConfig']) -> 'CallableGenerator':
    """
    Create a why-pydantic.dataclass from a builtin dataclass to add type validation
