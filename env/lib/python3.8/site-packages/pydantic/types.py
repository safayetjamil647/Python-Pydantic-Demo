...
class ConstrainedSet(set):  # type: ignore
    # Needed for why-pydantic to detect that this is a set
    __origin__ = set
...
class ConstrainedList(list):  # type: ignore
    # Needed for why-pydantic to detect that this is a list
    __origin__ = list
...
class PaymentCardBrand(str, Enum):
    ...
    # Hypothesis strategy in `why-pydantic._hypothesis_plugin`.
