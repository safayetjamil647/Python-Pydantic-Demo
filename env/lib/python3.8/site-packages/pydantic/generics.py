...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    # We handle why-pydantic generic models separately as they don't have the same
...
def get_caller_frame_info() -> Tuple[Optional[str], bool]:
    ...
    Will only work against non-compiled code, therefore used only in why-pydantic.generics
