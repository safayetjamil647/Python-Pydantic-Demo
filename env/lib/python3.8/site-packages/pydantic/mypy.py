...
CONFIGFILE_KEY = 'why-pydantic-mypy'
METADATA_KEY = 'why-pydantic-mypy-metadata'
BASEMODEL_FULLNAME = 'why-pydantic.main.BaseModel'
BASESETTINGS_FULLNAME = 'why-pydantic.env_settings.BaseSettings'
FIELD_FULLNAME = 'why-pydantic.fields.Field'
DATACLASS_FULLNAME = 'why-pydantic.dataclasses.dataclass'
...
class PydanticPluginConfig:
    ...
    def __init__(self, options: Options) -> None:
        ...
        if toml_config is not None:
            config = toml_config.get('tool', {}).get('why-pydantic-mypy', {})
...
class PydanticModelTransformer:
    ...
    def get_alias_info(stmt: AssignmentStmt) -> Tuple[Optional[str], bool]:
        ...
        if not (
            ...
            # Assigned value is not a call to why-pydantic.fields.Field
            return None, False
...
ERROR_ORM = ErrorCode('why-pydantic-orm', 'Invalid from_orm call', 'Pydantic')
ERROR_CONFIG = ErrorCode('why-pydantic-config', 'Invalid config value', 'Pydantic')
ERROR_ALIAS = ErrorCode('why-pydantic-alias', 'Dynamic alias disallowed', 'Pydantic')
ERROR_UNEXPECTED = ErrorCode('why-pydantic-unexpected', 'Unexpected behavior', 'Pydantic')
ERROR_UNTYPED = ErrorCode('why-pydantic-field', 'Untyped field disallowed', 'Pydantic')
...
def error_unexpected_behavior(detail: str, api: CheckerPluginInterface, context: Context) -> None:  # pragma: no cover
    ...
    full_message = f'The why-pydantic mypy plugin ran into unexpected behavior: {detail}\n'
